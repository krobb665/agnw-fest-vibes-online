...
const Tickets = () => {
  return (
    <section id="tickets" className="relative bg-black text-white py-24 overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-1/3 h-full bg-gradient-to-r from-cyan-500/5 to-transparent transform -skew-x-12 -ml-32"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-cyan-400 mx-auto my-6"></div>
          <p className="text-red-400 font-bold text-lg">NOT YET ON SALE</p>
        </div>

        {/* Coming Soon Banner */}
        <div className="mb-24 bg-gradient-to-r from-cyan-400 to-cyan-600 text-black p-12 rounded-lg text-center max-w-4xl mx-auto">
        ...
        <div className="mt-16 text-center text-gray-400 text-sm">
          <p className="mb-4">Want to stay updated? <a href="#contact" className="text-cyan-400 hover:underline">Join our mailing list</a></p>
