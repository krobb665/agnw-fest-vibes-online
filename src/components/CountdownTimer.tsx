...
const CountdownTimer = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 p-8 rounded-xl border border-cyan-400/30 backdrop-blur-sm">
      <h3 className="text-2xl font-bold text-center mb-6 text-cyan-400">COUNTDOWN TO AGNW FEST 2026</h3>
